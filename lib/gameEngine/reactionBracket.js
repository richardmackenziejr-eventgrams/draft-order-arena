...
const description = 'A single-elimination bracket where every match is a reaction-time duel — fastest click wins and advances. Play it live head-to-head, or race the clock on your own schedule.';
