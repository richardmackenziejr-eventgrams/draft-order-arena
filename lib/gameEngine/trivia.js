...
// dealt a random 10 questions from a shared pool and races a 5-second clock on
// each one: answering correctly with 3+ seconds left earns 3 points, 2+ left
// earns 2, 1+ left earns 1, and running out (or answering wrong) earns 0.
// Ranked by total points, ties broken by total time taken (faster wins).
const id = 'trivia';
const name = 'Football Trivia';
const description = 'Real NFL trivia from the last 20 years, one question at a time on a 5-second clock — answer fast for more points. 10 random questions per player from a shared pool.';
...
const QUESTIONS = [
  ...
  { id: 'sbw4', text: 'Who won Super Bowl XLII, spoiling the Patriots\' undefeated season?', choices: ['New York Giants', 'Green Bay Packers', 'Dallas Cowboys', 'Tampa Bay Buccaneers'], correctIndex: 0 },
  ...
  { id: 'sbw8', text: 'Who won Super Bowl XLVI, beating the Patriots for the second time in five years?', choices: ['New York Giants', 'San Francisco 49ers', 'Baltimore Ravens', 'Denver Broncos'], correctIndex: 0 },
  { id: 'sbw9', text: 'Who won Super Bowl XLVII, the "Harbaugh Bowl" against the 49ers?', choices: ['Seattle Seahawks', 'Baltimore Ravens', 'Atlanta Falcons', 'New England Patriots'], correctIndex: 1 },
  { id: 'sbw10', text: 'Who won Super Bowl XLVIII, routing the Broncos 43-8?', choices: ['Denver Broncos', 'San Francisco 49ers', 'Seattle Seahawks', 'New Orleans Saints'], correctIndex: 2 },
  { id: 'sbw11', text: 'Who won Super Bowl XLIX, sealed by a goal-line interception?', choices: ['Seattle Seahawks', 'New England Patriots', 'Green Bay Packers', 'Arizona Cardinals'], correctIndex: 1 },
  ...
  { id: 'sbw13', text: 'Who won Super Bowl LI after trailing 28-3?', choices: ['Atlanta Falcons', 'Green Bay Packers', 'New England Patriots', 'Pittsburgh Steelers'], correctIndex: 2 },
  { id: 'sbw14', text: 'Who won Super Bowl LII, upsetting the Patriots?', choices: ['Philadelphia Eagles', 'Minnesota Vikings', 'Jacksonville Jaguars', 'New Orleans Saints'], correctIndex: 0 },
  ...
  { id: 'sbw16', text: 'Who won Super Bowl LIV, ending a 50-year title drought?', choices: ['San Francisco 49ers', 'Kansas City Chiefs', 'Tennessee Titans', 'Green Bay Packers'], correctIndex: 1 },
  ...
  { id: 'sbw18', text: 'Who won Super Bowl LVI, played in their home stadium?', choices: ['Cincinnati Bengals', 'Los Angeles Rams', 'San Francisco 49ers', 'Tennessee Titans'], correctIndex: 1 },
  ...
  { id: 'sbw20', text: 'Who won Super Bowl LVIII in overtime?', choices: ['San Francisco 49ers', 'Baltimore Ravens', 'Kansas City Chiefs', 'Detroit Lions'], correctIndex: 2 },
  ...
  // --- Super Bowl MVPs ---
  { id: 'sbm1', text: 'Who was named Super Bowl XLII MVP after the Giants beat the undefeated Patriots?', choices: ['Plaxico Burress', 'David Tyree', 'Eli Manning', 'Michael Strahan'], correctIndex: 2 },
  { id: 'sbm2', text: 'Who was named Super Bowl XLIV MVP?', choices: ['Reggie Bush', 'Drew Brees', 'Peyton Manning', 'Tracy Porter'], correctIndex: 1 },
  { id: 'sbm3', text: 'Who was named Super Bowl XLV MVP?', choices: ['Aaron Rodgers', 'Ben Roethlisberger', 'Greg Jennings', 'Clay Matthews'], correctIndex: 0 },
  { id: 'sbm4', text: 'Who was named Super Bowl XLVIII MVP despite not being a quarterback?', choices: ['Russell Wilson', 'Marshawn Lynch', 'Malcolm Smith', 'Richard Sherman'], correctIndex: 2 },
  { id: 'sbm5', text: 'Who was named Super Bowl XLIX MVP after New England\'s comeback win?', choices: ['Julian Edelman', 'Tom Brady', 'Rob Gronkowski', 'Malcolm Butler'], correctIndex: 1 },
  { id: 'sbm6', text: 'Who was named Super Bowl 50 MVP as a member of the Broncos\' defense?', choices: ['Von Miller', 'DeMarcus Ware', 'Chris Harris Jr.', 'T.J. Ward'], correctIndex: 0 },
  { id: 'sbm7', text: 'Who was named Super Bowl LI MVP after the 28-3 comeback?', choices: ['Julian Edelman', 'James White', 'Tom Brady', 'Danny Amendola'], correctIndex: 2 },
  { id: 'sbm8', text: 'Who was named Super Bowl LII MVP, a backup quarterback at the time?', choices: ['Carson Wentz', 'Nick Foles', 'Zach Ertz', 'Alshon Jeffery'], correctIndex: 1 },
  { id: 'sbm9', text: 'Who was named Super Bowl LIII MVP?', choices: ['Tom Brady', 'Sony Michel', 'Julian Edelman', 'Stephon Gilmore'], correctIndex: 2 },
  { id: 'sbm10', text: 'Who was named Super Bowl LIV MVP?', choices: ['Patrick Mahomes', 'Travis Kelce', 'Damien Williams', 'Tyreek Hill'], correctIndex: 0 },
  { id: 'sbm11', text: 'Who was named Super Bowl LV MVP as the Buccaneers routed the Chiefs?', choices: ['Rob Gronkowski', 'Tom Brady', 'Leonard Fournette', 'Antonio Brown'], correctIndex: 1 },
  { id: 'sbm12', text: 'Who was named Super Bowl LVI MVP with two touchdown catches, including the game-winner?', choices: ['Matthew Stafford', 'Cooper Kupp', 'Aaron Donald', 'Odell Beckham Jr.'], correctIndex: 1 },
  { id: 'sbm13', text: 'Who was named Super Bowl LVII MVP?', choices: ['Jalen Hurts', 'Travis Kelce', 'Patrick Mahomes', 'A.J. Brown'], correctIndex: 2 },
  { id: 'sbm14', text: 'Who won Super Bowl LVIII MVP, his third Super Bowl MVP award?', choices: ['Patrick Mahomes', 'Travis Kelce', 'Brock Purdy', 'Christian McCaffrey'], correctIndex: 0 },
  { id: 'sbm15', text: 'Who was named Super Bowl LIX MVP?', choices: ['Saquon Barkley', 'Jalen Hurts', 'A.J. Brown', 'Patrick Mahomes'], correctIndex: 1 },
...
function submitAnswer(state, memberId, choiceIndex) {
  ...
  let points = 0;
  if (correct) {
    if (remainingSeconds >= 3) points = 3;
