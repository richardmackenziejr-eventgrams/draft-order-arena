...
const POWER_PERIOD_MS = 1150; // one full up-down cycle of the power meter
const DIRECTION_PERIOD_MS = 1150; // one full left-right cycle of the direction meter
const POWER_SWEET_HALF = 0.09; // half-width of the visible green band (0..1 space)
