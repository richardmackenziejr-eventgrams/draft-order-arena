...
const description = 'A single weighted draw decides the whole order at once — set odds from last year\'s standings, or make it completely random. Watch it play out as a 100-yard race.';
